...
class Array(object):
   ...
   #Modificacion del método inserciónSort()
   def insertionSort2(self): # Ordenar por inserciones repetidas
      # Contadores
      copias = 0
      compariciones = 0
      for outer in range(1, self.__nItems):
         ...
         self.__a[inner] = temp
         copias += 1
      print("Numero de copias:", copias)
      print("Numero de comparaciones:", compariciones)
